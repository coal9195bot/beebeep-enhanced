...
public:
  ...
  enum ConnectionKeyExchangeMethod { ConnectionKeyExchangeAuto, ConnectionKeyExchangeECDH, NumConnectionKeyExchangeMethods };
  bool isConnectionKeyExchangeOnlyECDH() const;
  ...
  inline int chatBubbleTheme() const;
  inline void setChatBubbleTheme( int );
  inline bool chatBubbleCompactPadding() const;
  inline void setChatBubbleCompactPadding( bool );
  ...
  QString defaultListBackgroundColor() const;
  QString defaultSystemBackgroundColor() const;
  void resetAllColors();
...
private:
  ...
  int m_connectionKeyExchangeMethod;
  ...
  bool m_chatCompact;
  int m_chatBubbleTheme;          // 0=iMessage, 1=WhatsApp, 2=Telegram, 3=Classic
  bool m_chatBubbleCompactPadding;
...
inline int Settings::chatBubbleTheme() const { return m_chatBubbleTheme; }
inline void Settings::setChatBubbleTheme( int new_value ) { m_chatBubbleTheme = new_value; }
inline bool Settings::chatBubbleCompactPadding() const { return m_chatBubbleCompactPadding; }
inline void Settings::setChatBubbleCompactPadding( bool new_value ) { m_chatBubbleCompactPadding = new_value; }
