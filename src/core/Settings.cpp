...
void Settings::loadCommonSettings( QSettings* user_ini )
{
  ...
  m_chatBubbleTheme = commonValue( system_rc, user_ini, "BubbleTheme", 0 ).toInt();
  m_chatBubbleCompactPadding = commonValue( system_rc, user_ini, "BubbleCompactPadding", true ).toBool();
...
void Settings::save()
{
  ...
  sets->setValue( "BubbleTheme", m_chatBubbleTheme );
  sets->setValue( "BubbleCompactPadding", m_chatBubbleCompactPadding );
